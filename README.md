...
> **[Official UltimateRepairing website][Plugin page]**
>
...
UltimateRepairing is a Minecraft item-repair server plugin developed and maintained by
**Songoda Reborn**.

It gives players a graphical repair workflow with configurable economy options, visual
effects, and server-controlled settings.
...
## Documentation
The [UltimateRepairing wiki][Plugin wiki] is maintained by Songoda Reborn and covers
installation, configuration, commands, permissions, dependencies, and compatibility.

## Support
For help with UltimateRepairing, join our [Discord server][Discord invite].

## Suggestions
Share feature suggestions and feedback through our [Discord server][Discord invite].


[Plugin page]: https://songoda-reborn.com/plugins/ultimaterepairing
[Plugin wiki]: https://songoda-reborn.com/plugins/ultimaterepairing/wiki
